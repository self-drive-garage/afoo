...
/// @class Status
/// @brief Represents the outcome of an operation, with detailed error
/// information if applicable.
///
/// This class encapsulates both a basic status (success or error) and,
/// in the case of errors, provides detailed information about the type of
/// error.
class Status {
 public:
  ...
  Status(STATUS bs = STATUS::SUCCESS, ERROR et = ERROR::NONE,
