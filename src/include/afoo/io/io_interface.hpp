...
class IOInterface {
 public:
  ...
  ///
  /// @return Status indicating the result of the operation. Success or Error
  /// details.
  ...
  ///
  /// Performs any necessary initialization steps after opening the connection
  /// or file. This method must be implemented by the derived class to handle
  ...
  /// This method must be implemented by the derived class to handle specific
  /// write operations.
  ///
  ...
  ///
  /// Reads data or a response based on a request from the open connection or
  /// file. This method must be implemented by the derived class to handle
  /// specific read operations.
  ///
  /// @param request The request for which the response is desired.
  /// @return A tuple containing the status of the read operation and the
  /// optional data received.
  virtual std::tuple<Status, std::optional<T>> read(
  ...
  virtual bool isOpened() const { return isOpened_; }

  /// @brief Check if the connection or file has been initialized after opening.
  ///
  /// @return True if the connection or file has been initialized, otherwise
  /// false.
  virtual bool isInitialized() const { return isInitialized_; }

 protected:
  bool isInitialized_{false};  ///< Indicates whether the connection or file has
                               ///< been initialized.
  bool isOpened_{
      false};  ///< Indicates whether the connection or file is currently open.
