...
/// manage a single device instance across multiple consumers while being thread
/// safe.
class BoostSerialDeviceManager {
 public:
  ...
  /// @note This method is thread-safe and ensures that only one device is
  /// created.
  ...
  /// @param request The data or command to send to the device before reading
  /// the response.
  /// @return A tuple containing the status of the operation and the optional
  /// read data.
